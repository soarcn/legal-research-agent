...
## P0 assumptions requiring awareness

1. The accepted 60/20/20 split did not specify a seed. P0 uses `20260721`, the decision date. Changing it creates a new benchmark version.
...
6. P6 structured output uses two total attempts (initial plus one repair retry); this operational value was not explicitly selected in the discussion and needs owner confirmation with the split seed.
